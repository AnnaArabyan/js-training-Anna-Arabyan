...
// console.log(JSON.stringify(collectCharacters(inputText)));
...
// const { userInput } = require("../UserInput");
// const inputText1 = userInput("Please, enter numbers ");
// let myArray = inputText1.split("");
// let newArray = [];
