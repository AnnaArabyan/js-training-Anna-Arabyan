...
function salaryCalculation(grossSalary) {
  return isNaN(grossSalary) || grossSalary <= 0 ? "Invalid input" : grossSalary;
}

function incomeTaxCalculation(grossSalary) {
  return grossSalary * 0.2;
}

function SocialSecurityContributionCalculation(grossSalary) {
  let SocialSecurityContributionTax;
  if (grossSalary < 500000) {
    SocialSecurityContributionTax = grossSalary * 0.05;
  } else if (grossSalary >= 500000 && grossSalary <= 1125000) {
    SocialSecurityContributionTax = grossSalary * 0.1 - 25000;
  } else {
    SocialSecurityContributionTax = 1125000 * 0.1 - 25000;
  }
  return SocialSecurityContributionTax;
}

function stampDutyCalculation(grossSalary) {
  let stampDutyTax;
